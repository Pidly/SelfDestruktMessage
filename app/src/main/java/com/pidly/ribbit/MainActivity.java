...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            switch(i){
                case 0: // Take Pic
                    ...
                    if(mMediaUri == null){
                        //Display error
                        Toast.makeText(MainActivity.this, "Error with storage", Toast.LENGTH_LONG).show();
                    }
                    else {
    ...
    private Uri getOutputMediaFileUri(int mediaType) {
        // To be safe, you should check that the SDCard/storage is mounted
        ...
        if(isExternalStorageAvailable()){
            ...
            if(!mediaStorageDir.exists()){
                if(!mediaStorageDir.mkdirs()){
                    Log.e(TAG, "Path?: " + mediaStorageDir.getPath());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK){
            ...
            if(requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST){
                ...
                if(requestCode == PICK_VIDEO_REQUEST){
                    ...
                    if(fileSize >= FILE_SIZE_LIMIT){
                        Toast.makeText(this, "Selected file it too large", Toast.LENGTH_LONG).show();
                        return;
                    }
                }
            }
            ...
            Toast.makeText(this, "Error with result", Toast.LENGTH_LONG).show();
